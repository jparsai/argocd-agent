...
func (suite *ClusterInfoTestSuite) Test_ClusterCacheInfo() {
	...
	// We need to know the number of existing applications before creating any new application
	...
	// Step 9:
	// Since agent is disconnected, cluster cache info should be reset to defaults
	requires.Eventually(func() bool {
