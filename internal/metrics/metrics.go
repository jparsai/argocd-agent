...
type PrincipalMetrics struct {
	...
	AgentConnectionAttempts *prometheus.CounterVec
...
func NewPrincipalMetrics() *PrincipalMetrics {
	return &PrincipalMetrics{
		...
		AppSetCreated: promauto.NewCounter(prometheus.CounterOpts{
			Name: "principal_appsets_created",
		...
		AppSetUpdated: promauto.NewCounter(prometheus.CounterOpts{
			Name: "principal_appsets_updated",
		...
		AgentConnectionAttempts: promauto.NewCounterVec(prometheus.CounterOpts{
			Name: "argocd_principal_agent_connection_attempts_total",
			Help: "The total number of times each agent connected to the principal",
		}, []string{"agent_name"}),
...
func NewAgentMetrics() *AgentMetrics {
	return &AgentMetrics{
		...
		ConnectionAttempts: promauto.NewCounter(prometheus.CounterOpts{
			Name: "argocd_agent_connection_attempts_total",
			Help: "The total number of times the agent connected to the principal",
		}),
