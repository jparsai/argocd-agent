...
| `argocd_principal_agent_connection_attempts_total` | Counter | Total connection attempts per agent (label: `agent_name`) |
...
| `principal_appsets_created` | Counter | Total ApplicationSets created |
| `principal_appsets_updated` | Counter | Total ApplicationSets updated |
| `principal_appsets_deleted` | Counter | Total ApplicationSets deleted |
...
| `argocd_agent_connection_attempts_total` | Counter | Total connection attempts to the principal |
