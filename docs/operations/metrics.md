...
| `argocd_principal_agent_connection_attempts_total` | counterVec | The total number of times each agent connected to the principal. |
...
| `principal_appsets_created` | counter | The total number of ApplicationSets created on the control plane. |
| `principal_appsets_updated` | counter | The total number of ApplicationSets updated on the control plane. |
| `principal_appsets_deleted` | counter | The total number of ApplicationSets deleted on the control plane. |
| `principal_gpg_keys_count` | gauge | The current number of GPG keys on the control plane. |
...
| `argocd_agent_connection_attempts_total` | counter | The total number of times the agent connected to the principal. |
